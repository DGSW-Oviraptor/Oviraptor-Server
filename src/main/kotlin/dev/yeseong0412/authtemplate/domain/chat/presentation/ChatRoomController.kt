...
class ChatRoomController(
    ...
    @GetMapping("/{roomId}")
    fun getAllMessages(@PathVariable roomId: Long, @RequestParam(required = false) objectId: String?, @GetAuthenticatedId userId: Long): BaseResponse<List<ChatMessageInfo>> {
